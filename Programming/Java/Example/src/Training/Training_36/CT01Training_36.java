 ...
 * Training 36
 */
public class CT01Training_36 {
	/** 초기화 */
	public static void start(String[] args) {
		Scanner oScanner = new Scanner(System.in);
		CManager_Member oManager = new CManager_Member(PATH_MEMBER_INFO_FILE);
	 ...
	 * 경로
	 */
	private static final String PATH_MEMBER_INFO_FILE = "jdbc:sqlite:P_T01Training_36_01.db";
